...
if sWR <= 0.25:
    p1WMs = 1-3*wrstep
elif sWR > 0.25 and sWR <= 0.5:
    p1WMs = 1-2*wrstep
elif sWR > 0.5 and sWR <= 0.90:
    p1WMs = 1-wrstep
elif sWR > 0.90 and sWR <= 1.00:
    p1WMs = 1

if gWR <= 0.25:
    p1WMg = 1-3*wrstep
elif gWR > 0.25 and gWR <= 0.5:
    p1WMg = 1-2*wrstep
elif gWR > 0.5 and gWR <= 0.90:
    p1WMg = 1-wrstep
elif gWR > 0.90 and gWR <= 1.00:
    p1WMg = 1
...
if ratvar < 0.25:
    NRMp1 = 1-3*nrstep
elif 0.25 <= ratvar < 0.5:
    NRMp1 = 1-2*nrstep
elif 0.5 <= ratvar <= 0.79:
    NRMp1 = 1-nrstep
elif 0.79 < ratvar <= 1.00:
    NRMp1 = 1+nrstep
